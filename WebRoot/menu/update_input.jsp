...
<div id="formwrapper">
	...
	<fieldset>
		...
		<input type="button" value="删除菜单信息" onclick="window.location = 'system/menu!del.action?id=${id}'"/>
		</legend>
		<div>
		...
		<div>
			...
			<input type="text" name="orderNumber" id="orderNumber" value="${orderNumber }" size="15"  /> 
			<br />	
		</div>
		<div>
