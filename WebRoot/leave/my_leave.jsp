...
$(function(){
	...
	oTable = $('#personList').dataTable( {
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "system/person!list.action?id="+<s:property value="id"/>,
...
<table id="roleList" class="display" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
	<caption>我的请假单列表</caption>
	<thead>
      <tr>
        <th height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">ID</span></div></th>
        <th height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">请假时间</span></div></th>
        <th height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">请假事项</span></div></th>
        <th height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">状态</span></div></th>
    ...
    <tbody>
    	...
    	<tr>
    		...
    		<td><s:property value="leaveContent"/></td>
    		<td><s:property value="status"/></td>
    		<td>
    			<s:if test="status == 'START'">
    			<a href="office/leave!start.action?id=<s:property value="id"/>">提交</a>
    			</s:if>
    		</td>
    	</tr>
    	</s:iterator>
