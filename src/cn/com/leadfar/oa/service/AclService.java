...
public interface AclService {
	 ...
	 * 
	 * @param principalType 主体类型，比如：Role/User/Position/Department
	 * @param principalId 主体ID
	 * @param resourceType 资源类型
	 * @return [资源ID，操作标识(CREATE/UPDATE/DELETE/READ或其它任何自定义的值)，允许状态(true/false)，是否继承(true/false)]
	 */
	...
	/**
	 * 查询某个用户（一般是当前登录用户）具有访问权限的菜单资源
	 * 登录以后，在显示管理菜单的时候，将调用本方法
	 * @param userId
	 * @return
	 */
